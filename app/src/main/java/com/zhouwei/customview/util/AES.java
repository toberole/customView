...
public class AES {
     ...
     * @return
     */
    public static AES getInstance(String salt) {
        if (!TextUtils.isEmpty(salt)) {
            AES.salt = salt.getBytes();
        } else {
            throw new IllegalArgumentException("You should provide salt");
        }
    ...
    private AES() {
        ...
        Log.i("AAAA",Base64.encodeToString(skAsByteArray,Base64.DEFAULT));
     ...
     * 解密
     *
     * @param ciphertext_base64 解密的字符串
     * @return 解密的结果
     */
